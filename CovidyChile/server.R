...
output$todos<-renderPlotly({
  ...
  tasa_crecimiento_nacional<-resumen_nacional()
  tasa_crecimiento_nacional$Fecha<-as.Date(tasa_crecimiento_nacional$Fecha)
  tasa_crecimiento_nacional_2<-select(tasa_crecimiento_nacional,`Fecha`, `Casos activos`,`Casos nuevos con sintomas`,`Casos nuevos sin sintomas`,`Casos nuevos totales`,`Casos recuperados`,`Casos totales`,Fallecidos)
  rm(tasa_crecimiento_nacional)
  
  
 
  tasa_crecimiento_nacional_2<-gather(tasa_crecimiento_nacional_2,key="Tipo de caso",value = "Casos", `Casos activos`,`Casos nuevos con sintomas`,`Casos nuevos sin sintomas`,`Casos nuevos totales`,`Casos recuperados`,`Casos totales`,Fallecidos)
...
output$todos_normalizado<-renderPlotly({
  ...
  tasa_crecimiento_nacional<-resumen_nacional()
  tasa_crecimiento_nacional$Fecha<-as.Date(tasa_crecimiento_nacional$Fecha)
  tasa_crecimiento_nacional_2<-select(tasa_crecimiento_nacional,`Fecha`,`Casos nuevos con sintomas cada 100000 habitantes`,`Casos nuevos sin sintomas cada 100000 habitantes`,`Casos nuevos totales cada 100000 habitantes`,`Casos activos cada 100000 habitantes`,`Casos recuperados cada 100000 habitantes`,`Casos totales cada 100000 habitantes`,`Casos fallecidos cada 100000 habitantes`)
  rm(tasa_crecimiento_nacional)
  
 
  tasa_crecimiento_nacional_2<-gather(tasa_crecimiento_nacional_2,key="Tipo de caso",value = "Casos",`Casos nuevos con sintomas cada 100000 habitantes`,`Casos nuevos sin sintomas cada 100000 habitantes`,`Casos nuevos totales cada 100000 habitantes`,`Casos activos cada 100000 habitantes`,`Casos recuperados cada 100000 habitantes`,`Casos totales cada 100000 habitantes`,`Casos fallecidos cada 100000 habitantes`)
  tasa_crecimiento_nacional_2$`Tipo de caso`<-as.factor(tasa_crecimiento_nacional_2$`Tipo de caso`)
  z<-ggplot(tasa_crecimiento_nacional_2,aes(Fecha,Casos,col=`Tipo de caso`))+geom_point(size=1)
...
#gvisMotionChart(datos_paises,idvar="Country Name",timevar="Date",
