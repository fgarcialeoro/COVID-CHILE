...
ui <- fluidPage(  
    ...
    tabsetPanel( 
        ...
        tabPanel("Infectados acumulados y mapas",
                 sidebarLayout(
                   sidebarPanel(
